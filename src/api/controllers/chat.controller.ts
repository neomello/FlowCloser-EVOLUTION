...
export class ChatController {
  ...
  public async readMessage(
    ...
    return await this.waMonitor.waInstances[instanceName].markMessageAsRead(
      data
    );
  }
  ...
  public async fetchProfilePicture(
    ...
    return await this.waMonitor.waInstances[instanceName].profilePicture(
      data.number
    );
  }
  ...
  public async fetchStatusMessage(
    ...
    return await this.waMonitor.waInstances[instanceName].fetchStatusMessage(
      query
    );
  }
  ...
  public async findChatByRemoteJid(
    { instanceName }: InstanceDto,
    remoteJid: string
  ) {
    return await this.waMonitor.waInstances[instanceName].findChatByRemoteJid(
      remoteJid
    );
  }
  ...
  public async updatePrivacySettings(
    ...
    return await this.waMonitor.waInstances[instanceName].updatePrivacySettings(
      data
    );
  }
  ...
  public async updateProfileName(
    ...
    return await this.waMonitor.waInstances[instanceName].updateProfileName(
      data.name
    );
  }
