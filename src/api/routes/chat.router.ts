...
export class ChatRouter extends RouterBroker {
  constructor(...guards: RequestHandler[]) {
    ...
    this.router
        ...
        try {
          const response = await this.dataValidate<WhatsAppNumberDto>({
            ...
            execute: (instance, data) =>
              chatController.whatsappNumber(instance, data),
          });
      ...
      .post(
        this.routerPath('markMessageAsRead'),
        ...guards,
        async (req, res) => {
          const response = await this.dataValidate<ReadMessageDto>({
            ...
            execute: (instance, data) =>
              chatController.readMessage(instance, data),
          });
      ...
      .post(this.routerPath('archiveChat'), ...guards, async (req, res) => {
        const response = await this.dataValidate<ArchiveChatDto>({
          ...
          execute: (instance, data) =>
            chatController.archiveChat(instance, data),
        });
      ...
      .post(this.routerPath('markChatUnread'), ...guards, async (req, res) => {
        const response = await this.dataValidate<MarkChatUnreadDto>({
          ...
          execute: (instance, data) =>
            chatController.markChatUnread(instance, data),
        });
      ...
      .delete(
        ...
        async (req, res) => {
          const response = await this.dataValidate<DeleteMessage>({
            ...
            execute: (instance, data) =>
              chatController.deleteMessage(instance, data),
          });
      ...
      .post(
        this.routerPath('fetchProfilePictureUrl'),
        ...guards,
        async (req, res) => {
          const response = await this.dataValidate<NumberDto>({
            ...
            ClassRef: NumberDto,
            execute: (instance, data) =>
              chatController.fetchProfilePicture(instance, data),
          });
      ...
      .post(
        this.routerPath('getBase64FromMediaMessage'),
        ...guards,
        async (req, res) => {
          const response =
            await this.dataValidate<getBase64FromMediaMessageDto>({
              request: req,
              schema: null,
      ...
      .post(this.routerPath('updateMessage'), ...guards, async (req, res) => {
        const response = await this.dataValidate<UpdateMessageDto>({
          ...
          execute: (instance, data) =>
            chatController.updateMessage(instance, data),
        });
      ...
      .post(this.routerPath('sendPresence'), ...guards, async (req, res) => {
        const response = await this.dataValidate<null>({
          ...
          execute: (instance, data) =>
            chatController.sendPresence(instance, data),
        });

        return res.status(HttpStatus.CREATED).json(response);
      })
      .post(
        this.routerPath('updateBlockStatus'),
        ...guards,
        async (req, res) => {
          const response = await this.dataValidate<BlockUserDto>({
            ...
            execute: (instance, data) =>
              chatController.blockUser(instance, data),
          });
      ...
      .post(this.routerPath('findContacts'), ...guards, async (req, res) => {
        const response = await this.dataValidate<Query<Contact>>({
          ...
          execute: (instance, data) =>
            chatController.fetchContacts(instance, data),
        });
      ...
      .post(
        this.routerPath('findStatusMessage'),
        ...guards,
        async (req, res) => {
          const response = await this.dataValidate<Query<MessageUpdate>>({
            ...
            execute: (instance, data) =>
              chatController.fetchStatusMessage(instance, data),
          });
      ...
      .post(this.routerPath('findChats'), ...guards, async (req, res) => {
        const response = await this.dataValidate<Query<Contact>>({
          ...
          ClassRef: Query<Contact>,
          execute: (instance, data) =>
            chatController.fetchChats(instance, data),
        });

        return res.status(HttpStatus.OK).json(response);
      })
      .get(
        this.routerPath('findChatByRemoteJid'),
        ...guards,
        async (req, res) => {
          ...
          if (!remoteJid) {
            return res
              ...
              .json({ error: 'remoteJid is a required query parameter' });
          }
          const response = await chatController.findChatByRemoteJid(
            instance,
            remoteJid
          );
      ...
      // Profile routes
      .post(
        this.routerPath('fetchBusinessProfile'),
        ...guards,
        async (req, res) => {
      ...
      .post(this.routerPath('fetchProfile'), ...guards, async (req, res) => {
        const response = await this.dataValidate<NumberDto>({
          ...
          ClassRef: NumberDto,
          execute: (instance, data) =>
            chatController.fetchProfile(instance, data),
        });

        return res.status(HttpStatus.OK).json(response);
      })
      .post(
        this.routerPath('updateProfileName'),
        ...guards,
        async (req, res) => {
          const response = await this.dataValidate<ProfileNameDto>({
            ...
            execute: (instance, data) =>
              chatController.updateProfileName(instance, data),
          });
      ...
      .post(
        this.routerPath('updateProfileStatus'),
        ...guards,
        async (req, res) => {
          const response = await this.dataValidate<ProfileStatusDto>({
            ...
            execute: (instance, data) =>
              chatController.updateProfileStatus(instance, data),
          });
      ...
      .post(
        this.routerPath('updateProfilePicture'),
        ...guards,
        async (req, res) => {
          const response = await this.dataValidate<ProfilePictureDto>({
            request: req,
      ...
      .delete(
        this.routerPath('removeProfilePicture'),
        ...guards,
        async (req, res) => {
          const response = await this.dataValidate<ProfilePictureDto>({
            request: req,
            ...
            ClassRef: ProfilePictureDto,
            execute: (instance) =>
              chatController.removeProfilePicture(instance),
          });
      ...
      .get(
        this.routerPath('fetchPrivacySettings'),
        ...guards,
        async (req, res) => {
          const response = await this.dataValidate<InstanceDto>({
            ...
            execute: (instance) =>
              chatController.fetchPrivacySettings(instance),
          });
      ...
      .post(
        this.routerPath('updatePrivacySettings'),
        ...guards,
        async (req, res) => {
