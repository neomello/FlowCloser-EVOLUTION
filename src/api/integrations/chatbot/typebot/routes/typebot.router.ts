...
import {
  TypebotDto,
  TypebotSettingDto,
} from '@api/integrations/chatbot/typebot/dto/typebot.dto';
    ...
    this.router
      .post(this.routerPath('create'), ...guards, async (req, res) => {
        const response = await this.dataValidate<TypebotDto>({
          ...
          execute: (instance, data) =>
            typebotController.createBot(instance, data),
        });
      ...
      .get(this.routerPath('fetch/:typebotId'), ...guards, async (req, res) => {
        const response = await this.dataValidate<InstanceDto>({
          ...
          ClassRef: InstanceDto,
          execute: (instance) =>
            typebotController.fetchBot(instance, req.params.typebotId),
        });

        res.status(HttpStatus.OK).json(response);
      })
      .put(
        this.routerPath('update/:typebotId'),
        ...guards,
        async (req, res) => {
          const response = await this.dataValidate<TypebotDto>({
            request: req,
            ...
            ClassRef: TypebotDto,
            execute: (instance, data) =>
              typebotController.updateBot(instance, req.params.typebotId, data),
          });
      ...
      .delete(
        this.routerPath('delete/:typebotId'),
        ...guards,
        async (req, res) => {
          const response = await this.dataValidate<InstanceDto>({
            request: req,
            ...
            ClassRef: InstanceDto,
            execute: (instance) =>
              typebotController.deleteBot(instance, req.params.typebotId),
          });
      ...
      .post(this.routerPath('settings'), ...guards, async (req, res) => {
        const response = await this.dataValidate<TypebotSettingDto>({
          ...
          execute: (instance, data) =>
            typebotController.settings(instance, data),
        });
      ...
      .post(this.routerPath('start'), ...guards, async (req, res) => {
        const response = await this.dataValidate<InstanceDto>({
          ...
          ClassRef: InstanceDto,
          execute: (instance, data) =>
            typebotController.startBot(instance, data),
        });
      ...
      .post(this.routerPath('changeStatus'), ...guards, async (req, res) => {
        const response = await this.dataValidate<InstanceDto>({
          ...
          ClassRef: InstanceDto,
          execute: (instance, data) =>
            typebotController.changeStatus(instance, data),
        });

        res.status(HttpStatus.OK).json(response);
      })
      .get(
        this.routerPath('fetchSessions/:typebotId'),
        ...guards,
        async (req, res) => {
          const response = await this.dataValidate<InstanceDto>({
            request: req,
            ...
            ClassRef: InstanceDto,
            execute: (instance) =>
              typebotController.fetchSessions(instance, req.params.typebotId),
          });
      ...
      .post(this.routerPath('ignoreJid'), ...guards, async (req, res) => {
        const response = await this.dataValidate<IgnoreJidDto>({
          ...
          execute: (instance, data) =>
            typebotController.ignoreJid(instance, data),
        });
