...
export class EvolutionBotRouter extends RouterBroker {
  constructor(...guards: RequestHandler[]) {
    ...
    this.router
      .post(this.routerPath('create'), ...guards, async (req, res) => {
        const response = await this.dataValidate<EvolutionBotDto>({
          ...
          execute: (instance, data) =>
            evolutionBotController.createBot(instance, data),
        });
      ...
      .get(
        this.routerPath('fetch/:evolutionBotId'),
        ...guards,
        async (req, res) => {
          const response = await this.dataValidate<InstanceDto>({
            request: req,
            ...
            ClassRef: InstanceDto,
            execute: (instance) =>
              evolutionBotController.fetchBot(
                instance,
                req.params.evolutionBotId
              ),
          });
      ...
      .put(
        this.routerPath('update/:evolutionBotId'),
        ...guards,
        async (req, res) => {
          const response = await this.dataValidate<EvolutionBotDto>({
            request: req,
            ...
            ClassRef: EvolutionBotDto,
            execute: (instance, data) =>
              evolutionBotController.updateBot(
                instance,
                req.params.evolutionBotId,
                data
              ),
      ...
      .delete(
        this.routerPath('delete/:evolutionBotId'),
        ...guards,
        async (req, res) => {
          const response = await this.dataValidate<InstanceDto>({
            request: req,
            ...
            ClassRef: InstanceDto,
            execute: (instance) =>
              evolutionBotController.deleteBot(
                instance,
                req.params.evolutionBotId
              ),
          });
      ...
      .post(this.routerPath('settings'), ...guards, async (req, res) => {
        const response = await this.dataValidate<EvolutionBotSettingDto>({
          ...
          execute: (instance, data) =>
            evolutionBotController.settings(instance, data),
        });
      ...
      .post(this.routerPath('changeStatus'), ...guards, async (req, res) => {
        const response = await this.dataValidate<InstanceDto>({
          ...
          ClassRef: InstanceDto,
          execute: (instance, data) =>
            evolutionBotController.changeStatus(instance, data),
        });

        res.status(HttpStatus.OK).json(response);
      })
      .get(
        this.routerPath('fetchSessions/:evolutionBotId'),
        ...guards,
        async (req, res) => {
          const response = await this.dataValidate<InstanceDto>({
            request: req,
            ...
            ClassRef: InstanceDto,
            execute: (instance) =>
              evolutionBotController.fetchSessions(
                instance,
                req.params.evolutionBotId
              ),
          });
      ...
      .post(this.routerPath('ignoreJid'), ...guards, async (req, res) => {
        const response = await this.dataValidate<IgnoreJidDto>({
          ...
          execute: (instance, data) =>
            evolutionBotController.ignoreJid(instance, data),
        });
